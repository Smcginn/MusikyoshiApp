...
/*!
	...
	@abstract define vertical location relative to the staff
 */
enum sscore_system_stafflocation_e { sscore_system_staffloc_undefined, sscore_system_staffloc_above, sscore_system_staffloc_instaff, sscore_system_staffloc_below };
 ...
 */
EXPORT enum sscore_system_stafflocation_e sscore_system_stafflocationforypos(const sscore_system *sys, int partindex, int staffindex, float ypos);
