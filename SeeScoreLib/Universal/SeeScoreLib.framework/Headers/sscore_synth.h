...
#include <stdbool.h>
	...
	//enum sscore_sy_sampledinstrument_flags{/* none yet*/};
	...
	/*!
	 ...
	 @abstract define voices for synthesized instrument (metronome ticks)
	 */
	enum sscore_sy_synthesizedinstrumentvoice
	{
		sscore_sy_tick1,
	...
	{
		unsigned dummy[64]; // for undefined future enhancements
	...
	EXPORT bool sscore_sy_unpause(sscore_synth *synth);
