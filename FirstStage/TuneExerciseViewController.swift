...
import AVFoundation
import AudioKit
// EMAIL ADD BACK   import MessageUI
...
// EMAIL ADD BACK   MFMailComposeViewControllerDelegate, MFMessageComposeViewControllerDelegate {
...
// EMAIL ADD BACK
    ...
    func sendEmail() {
        ...
        if MFMailComposeViewController.canSendMail() {
            ...
            mail.setToRecipients(["scott.musikyoshi@gmail.com"])
            mail.setMessageBody("<>Inst = Trombone<>BPM=120<>", isHTML: false)
            
            present(mail, animated: true)
            //return true
        } else {
            let email = "scott.musikyoshi@gmail.com"
 ...
 * /
    ...
    func sendSMS(with text: String) {
        if MFMessageComposeViewController.canSendText() {
            var msgBody = "<1.04,205.7><1.04,205.7><1.04,205.7><1.04,205.7><1.04,205.7>"
            msgBody += "<1.04,205.7><1.04,205.7><1.04,205.7><1.04,205.7><1.04,205.7>"
            msgBody += "<1.04,205.7><1.04,205.7><1.04,205.7><1.04,205.7><1.04,205.7>"
            msgBody += "<1.04,205.7><1.04,205.7><1.04,205.7><1.04,205.7><1.04,205.7>"
            msgBody += "<1.04,205.7><1.04,205.7><1.04,205.7><1.04,205.7><1.04,205.7>"
            msgBody += "<1.04,205.7><1.04,205.7><1.04,205.7><1.04,205.7><1.04,205.7>"
            ...
            messageComposeViewController.body = msgBody
